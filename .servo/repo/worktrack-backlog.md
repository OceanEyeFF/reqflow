...
> 所有 worktrack 的注册表，按 milestone 组织。
...
- status: completed
- priority: 1
- contract_path: .servo/worktrack/WT-20260523-001/contract.md
- branch: worktrack/wt-20260523-001-readme (merged → deleted)
...
- status: completed
- priority: 2
- contract_path: .servo/worktrack/WT-20260523-002/contract.md
- branch: worktrack/wt-20260523-002-handoff (merged)
...
- status: completed
- priority: 3
- contract_path: .servo/worktrack/WT-20260523-003/contract.md
- branch: worktrack/wt-20260523-003-lint-ts (merged → deleted)
...
- status: completed
- priority: 4
- contract_path: .servo/worktrack/WT-20260523-004/contract.md
- branch: worktrack/wt-20260523-004-build (merged → deleted)

## M2: 分模块代码质量治理 (MS-20260523-002)
...
- status: completed
- priority: 1
- contract_path: .servo/worktrack/WT-20260523-005/contract.md
- branch: worktrack/wt-20260523-005-auth (merged)
...
- status: completed
- priority: 2
- contract_path: .servo/worktrack/WT-20260523-006/contract.md
- branch: worktrack/wt-20260523-006-tickets (merged)

### WT-20260523-007

- worktrack_id: WT-20260523-007
- title: Comments/Members API 审查与修复
- milestone_id: MS-20260523-002
- node_type: refactor
- status: completed
- priority: 3
- contract_path: .servo/worktrack/WT-20260523-007/contract.md
- branch: worktrack/wt-20260523-007-comments-members (merged)
...
- status: completed
- priority: 4
- contract_path: .servo/worktrack/WT-20260523-008/contract.md
- branch: worktrack/wt-20260523-008-att-notif (merged)
...
- status: completed
- priority: 5
- contract_path: .servo/worktrack/WT-20260523-009/contract.md
- branch: worktrack/wt-20260523-009-frontend (merged)
...
- status: completed
- priority: 2
- contract_path: .servo/worktrack/WT-20260523-012/contract.md
- branch: worktrack/wt-20260523-012-tickets-api-tests (merged)
...
- merge_commit: 35ae590d648f2e9b491684b925221850f7a3f551
